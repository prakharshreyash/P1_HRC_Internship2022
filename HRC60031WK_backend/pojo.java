...
public class pojo {
	...
	public pojo(int sl_no, String business_code, int cust_number, String clear_date, String buisness_year,
			String doc_id, String posting_date, String document_create_date, String document_create_date1,
			String due_in_date, String invoice_currency, String document_type, int posting_id, double area_business,
	...
	public double getArea_business() {
		return area_business;
	}
	public void setArea_business(double area_business) {
		this.area_business = area_business;
	}
